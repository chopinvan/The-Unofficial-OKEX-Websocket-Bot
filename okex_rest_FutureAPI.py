...
#https://www.okex.com/api/v1/future_trades.do?symbol=eos_usd&contract_type=quarter
...
class OKCoinFuture:
    ...
    #期货逐仓账户信息
    def future_userinfo_4fix(self):  ## not usable
    ...
    #获取当前可用合约总持仓量
    def future_hold_amount(self):   # bad
        FUTURE_HOLDAMOUNT = "/api/v1/future_hold_amount.do"
        params ={}
        params['api_key'] = self.__apikey
        params['sign'] = buildMySign(params,self.__secretkey)
        return httpGet(self.__url,FUTURE_HOLDAMOUNT,params)

    #def future_return_chart_2000(self,symbol,type1,contractType,since): 
